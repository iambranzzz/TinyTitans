  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        glowNeon:
          "0 0 0 1px rgba(255,255,255,0.06), 0 18px 70px rgba(34,211,238,0.18), 0 35px 120px rgba(0,0,0,0.65)",
        glowEnergy:
          "0 0 0 1px rgba(255,255,255,0.06), 0 18px 70px rgba(232,121,249,0.18), 0 35px 120px rgba(0,0,0,0.65)",
        glowPlasma:
          "0 0 0 1px rgba(255,255,255,0.06), 0 18px 70px rgba(251,146,60,0.18), 0 35px 120px rgba(0,0,0,0.65)",
      },
      backdropBlur: {
        xs: "2px",
      },
      backgroundImage: {
        aurora:
          "radial-gradient(1200px 700px at 18% 0%, hsl(var(--space-neon) / 0.18), transparent 60%), radial-gradient(980px 640px at 85% 14%, hsl(var(--space-energy) / 0.16), transparent 62%), radial-gradient(900px 560px at 55% 108%, hsl(var(--space-plasma) / 0.12), transparent 62%), radial-gradient(760px 560px at 48% 44%, hsl(var(--space-cosmic) / 0.12), transparent 64%)",
        particles:
          "radial-gradient(circle at 18% 20%, rgba(255,255,255,0.18) 0 1px, transparent 1.5px), radial-gradient(circle at 72% 32%, rgba(255,255,255,0.12) 0 1px, transparent 1.5px), radial-gradient(circle at 38% 72%, rgba(255,255,255,0.14) 0 1px, transparent 1.5px), radial-gradient(circle at 84% 78%, rgba(255,255,255,0.10) 0 1px, transparent 1.5px), radial-gradient(circle at 58% 18%, rgba(255,255,255,0.08) 0 1px, transparent 1.5px)",
      },
      keyframes: {
        auroraFloat: {
